		...
		<>
			...
			<Container maxWidth="lg" disableGutters>
				...
				<ContentContainer flexDirection={ { xs: 'column-reverse', md: 'row' } }>
					<ContentCardMedia image="https://images.unsplash.com/photo-1667372283587-e1557c08aca4?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&h=300&ixid=MnwxfDB8MXxyYW5kb218MHx8RGF0YWJhc2V8fHx8fHwxNjkwODY4NTI1&ixlib=rb-4.0.3&q=80&utm_campaign=api-credit&utm_medium=referral&utm_source=unsplash_source&w=500"/>
				...
				<ContentContainer flexDirection={ { xs: 'column-reverse', md: 'row-reverse' } }>
					<ContentCardMedia image="https://images.unsplash.com/photo-1457369804613-52c61a468e7d?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&h=300&ixid=MnwxfDB8MXxyYW5kb218MHx8bGVhcm5pbmcgcHJvZ3JhbXx8fHx8fDE2OTA4NjkxMjM&ixlib=rb-4.0.3&q=80&utm_campaign=api-credit&utm_medium=referral&utm_source=unsplash_source&w=500"/>
					<Box width={ { xs: '100%', md: '50%' } } marginBottom={ { xs: '25px', md: 0 } }>
				...
				<Divider/>
				<ContentContainer flexDirection={ { xs: 'column-reverse', md: 'row' } }>
					<ContentCardMedia image="https://images.unsplash.com/photo-1523939158338-1708c2391359?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&h=300&ixid=MnwxfDB8MXxyYW5kb218MHx8QW55dGltZSBBbnl3aGVyZXx8fHx8fDE2OTA4Njk1MDE&ixlib=rb-4.0.3&q=80&utm_campaign=api-credit&utm_medium=referral&utm_source=unsplash_source&w=500"/>
					<Box width={ { xs: '100%', md: '50%' } } marginBottom={ { xs: '25px', md: 0 } }>
